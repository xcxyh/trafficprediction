...
if __name__ == '__main__':
    ...
    n = n.reshape(1, 100)  # reshape array to be 3x5
    label = np.random.randint(256,size=(100))
    label = label.reshape(1, 1, 100)  # reshape array to be 3x5
    from keras.utils import to_categorical
    label = to_categorical(label, 256)
